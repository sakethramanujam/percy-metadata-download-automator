...
# Comma-separated list, or "*" for open local/LAN dev (default).
CORS_ORIGINS = os.environ.get("PLAYGROUND_CORS_ORIGINS", "*")
...
API_HOST = os.environ.get("PLAYGROUND_API_HOST", "0.0.0.0")
API_PORT = int(os.environ.get("PLAYGROUND_API_PORT", "8000"))
...
def cors_origins() -> list[str]:
    ...
    # Always include common localhost variants + explicit CORS_ORIGIN
    for o in (CORS_ORIGIN, "http://127.0.0.1:5173", "http://localhost:5173"):
